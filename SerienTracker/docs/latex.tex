...
\centering
\hfill %
\subfloat[Startseite \label{pic:Anmelden}]{\includegraphics[width=.5\textwidth]{images/dokulayout/startseite.png}}
\hfill % alternativ auch \hspace{1cm} für genaue Angaben
\subfloat[Einloggen \label{pic:Registrieren}]{\includegraphics[width=.5\textwidth]{images/dokulayout/anmelden.png}}
\hfill %
...
\centering
\hfill 
\subfloat[Registrieren \label{pic:Registrieren}]{\includegraphics[width=.5\textwidth]{images/dokulayout/registrieren.png}}
\hfill % alternativ auch \hspace{1cm} für genaue Angaben
\subfloat[Prioritäten \label{pic:Prioritaeten}]{\includegraphics[width=.5\textwidth]{images/dokulayout/prioritaeten.png}}
\hfill %
...
\centering
\hfill %
\subfloat[Serienseite User \label{pic:Serienseite}]{\includegraphics[width=.5\textwidth]{images/dokulayout/serie.png}}
\hfill % alternativ auch \hspace{1cm} für genaue Angaben
\subfloat[Serienseite Admin \label{pic:Serienseite}]{\includegraphics[width=.5\textwidth]{images/dokulayout/serie2.png}}
\hfill %
...
\centering
\hfill %
\subfloat[Seasonseite \label{pic:Seasonseite}]{\includegraphics[width=.5\textwidth]{images/dokulayout/staffel.png}}
\hfill % alternativ auch \hspace{1cm} für genaue Angaben
\subfloat[Episode anlegen \label{pic:Episodenverwaltung}]{\includegraphics[width=.5\textwidth]{images/dokulayout/anlegen.png}}
\hfill %
